        ...
        <div className="liquid-glass-strong w-full max-w-md rounded-3xl p-8">
          <div className="mb-8 flex flex-col items-center">
            ...
            <p className="mt-1 text-sm text-foreground/60">
              {isLogin ? "Sign in to your NeuroPath account" : "Start your neural health journey"}
            </p>
          </div>
            ...
            {!isLogin && (
              <div>
                ...
                <input
                  ...
                  required={!isLogin}
                  className="liquid-glass w-full rounded-xl px-4 py-3 text-sm text-foreground placeholder-foreground/30 outline-none"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  minLength={6}
                  className="liquid-glass w-full rounded-xl px-4 py-3 pr-10 text-sm text-foreground placeholder-foreground/30 outline-none"
                  placeholder="••••••••"
                />
                <button
                  type="button"
